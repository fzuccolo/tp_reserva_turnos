...
public class PacienteController : ControllerBase
{
    ...
    public async Task<ActionResult> Delete(int id)
    {
        ...
        var turnos = await _context.Turnos.FirstOrDefaultAsync(t => t.PacienteId == id);
        if (turnos != null)
        {
            return BadRequest("No se puede eliminar al paciente porque tiene turnos asociados.");
        }
