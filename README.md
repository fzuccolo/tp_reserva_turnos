# Programación Avanzada II - TP Integrador
...
- Opcional: servidor web para servir los archivos estáticos del front. Si tiene instalado python,
  se puede utilizar el servidor de desarrollo:

            cd parte1/web
            python3 -m http.server 5500

  Y ver la aplicacion en el navegador apuntando a http://localhost:5500
...
- [Pruebas (Parte 1)](docs/parte1/pruebas.md)
- [Pruebas de la API (Parte 1)](docs/api/resultados.md)
...
- Tener instalado Node (ejecutar `node -v` para verificar)
- Tener instalado Angular:

        npm i -g @angular/cli
        ng version

- Servir la API de la parte 2:
...
- [Pruebas (Parte 2)](docs/parte2/pruebas.md)


## Cómo probar la API con Postman en Windows
